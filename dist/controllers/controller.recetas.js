...
exports.getRecetaUser = exports.getReceta = exports.generarPdfReceta = exports.generarExcelReceta = exports.disableReceta = exports.crearReceta = void 0;
...
var getReceta = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var ruta, option, Recetas, resultado;
  ...
  return function getReceta(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
exports.getReceta = getReceta;
var crearReceta = /*#__PURE__*/function () {
      ...
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          if (req.body.NOMBRE && req.body.DESCRIPCION) {
            ...
            try {
              respuesta = (0, _nodeFetch["default"])(url, option).then(function (response) {
                return response.json();
              }).then(function (data) {
                return (
                  //data:data
  ...
  return function crearReceta(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
exports.crearReceta = crearReceta;
var getRecetaUser = /*#__PURE__*/function () {
  ...
  return function getRecetaUser(_x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();
exports.getRecetaUser = getRecetaUser;
var disableReceta = /*#__PURE__*/function () {
  ...
  return function disableReceta(_x7, _x8) {
    return _ref4.apply(this, arguments);
  };
}();
exports.disableReceta = disableReceta;
var generarPdfReceta = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 3:
          ...
          doc.fontSize(24).text('Registro de recetas', {
            align: 'center'
          });
  ...
  return function generarPdfReceta(_x9, _x10) {
    return _ref5.apply(this, arguments);
  };
}();
exports.generarPdfReceta = generarPdfReceta;
var generarExcelReceta = /*#__PURE__*/function () {
  ...
  return function generarExcelReceta(_x11, _x12) {
    return _ref6.apply(this, arguments);
  };
}();
exports.generarExcelReceta = generarExcelReceta;