...
exports.loginUsuario = exports.inhabilitar = exports.getUsuarios = void 0;
...
var loginUsuario = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var data, ruta, option, datos, resultado, token, _ruta, _option, usuarios, _resultado;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          ruta = "http://localhost:3000/api/consult";
          option = {
            method: "POST",
            headers: {
        ...
        case 8:
          ...
          token = _jsonwebtoken["default"].sign(datos, process.env.SECRET_KEY, {
